...
7. Scroll up to the top, and click on your repo name to go back to its main page.
8. At the top level of your repo main page, click on README.md, and click the pencil icon to edit this file.
9. Delete the link to the our live site, as shown in Figure below, and paste in the link to your published site. Scroll down to Commit your changes.
